...
const outputPath = path.join(__dirname, "../src/WebSerialHTML.h");
...
(async function () {
  ...
  let content = `#ifndef WEBSERIAL_HTML_H
#define WEBSERIAL_HTML_H
...
#endif // WEBSERIAL_HTML_H`;

  // Write the content to the output file
  fs.writeFileSync(outputPath, content);

  console.log("WebSerialHTML.h file created successfully!");
})();
